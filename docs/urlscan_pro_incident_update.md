## urlscan pro incident update

Update an incident

```
urlscan pro incident update [flags]
```
...
```
  ...
  -o, --observable string                   Observable (hostname, domain, IP or URL) (required)
      ...
      --stop-delay-malicious int            Stop delay malicious in seconds (default 0)
      --stop-delay-suspended int            Stop delay suspended in seconds (default 0)
